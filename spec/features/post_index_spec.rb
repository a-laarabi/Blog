...
RSpec.describe 'Post index', type: :feature do
  before(:each) do
    ...
    Comment.create(post_id: @post.id, author_id: @user1.id, text: 'I really like this post. Good job!')
    Comment.create(post_id: @post2.id, author_id: @user1.id, text: 'I enjoyed reading your post very much!')
